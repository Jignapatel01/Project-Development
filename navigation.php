...
<section id="navigation">
     <div class="container-fluid ">
       ...
       <a href="index.php"> <img src="<?php echo $baseurl;?>image/royal logo1.png" alt="Maruti" width="90%" height="60px"/></a>
    </div>
        ...
        <div class="collapse navbar-collapse" id="coll">
            <div class="navbar-link">
             <ul>
                    ...
                    <li><a href="<?php echo $mainurl;?>aboutus">About</a></li>
                    <li><a href="<?php echo $mainurl;?>menu">Menu</a></li>
                    <li><a href="<?php echo $mainurl;?>menu">Specials</a></li>
                    <li><a href="<?php echo $mainurl;?>event">Events</a></li>
                    <li><a href="<?php echo $mainurl;?>gallery">Gallery</a></li>
                    <li><a href="<?php echo $mainurl;?>chefs">Chefs</a></li>
                    <li><a href="<?php echo $mainurl;?>contactus">Chefs</a></li>
                    <?php
